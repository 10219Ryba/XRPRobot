...
public class VoltageDriveCommand extends Command {
  ...
  @Override
  public void execute() {
    SmartDashboard.putNumber("left joystick Y",joystick.getLeftY());
    SmartDashboard.putNumber("left joystick X",joystick.getLeftX());
    SmartDashboard.putNumber("right joystick Y", joystick.getRightY());
    SmartDashboard.putNumber("right joystick X", joystick.getRightX());
